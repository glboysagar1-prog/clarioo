...
An AI-powered career guidance platform that helps students navigate their career journey from confusion to clarity. Built by **Team Quad Core** for Hack The Winter - The Second Wave (Angry Bird Edition) .
...
| Name              | Role                       | College                                   |
| ----------------- | -------------------------- | ----------------------------------------- |
| **Maheto Sagar Satendra**     | Team Leader                | GEC DAMAN(CE 2nd Year)                        |
| **Rohit panda**  | FullStack Dev & Researcher | GEC DAMAN (CE 2nd Year)            |
| **Makriya Shivamkumar Ghanshyam**          | UI/UX & R&D                | GEC DAMAN (CE 2nd Year)                        |
| **Smit Koli**         | Developer                  | GEC DAMAN (CE 2nd Year)                        |
...
- **Email**: Contact team leader Maheto Sagar Satendra
